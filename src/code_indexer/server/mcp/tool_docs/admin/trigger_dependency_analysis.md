...
tl_dr: 'Manually trigger dependency map analysis on demand.


  WHAT IT DOES:

  Starts a background analysis job to generate or refresh the dependency map that
  powers the cidx-meta repository.'
---
