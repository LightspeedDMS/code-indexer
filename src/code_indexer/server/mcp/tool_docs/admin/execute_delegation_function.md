...
RELATED TOOLS: For free-form objectives without pre-defined templates, use execute_open_delegation instead. It accepts any prompt with engine and mode selection.
