...
from ..routes.xray_routes import router as xray_router  # Story #974
from ..routes.regex_routes import router as regex_router  # Story #1011
from ..web import (
    web_router,
    user_router,
    login_router,
...
def register_inline_routes(
    ...
    app.include_router(regex_router)  # Story #1011
