...
# in this module (used by _get_conn below). Matches the 30s convention
...
# an OIDC login) is absorbed by SQLite's own internal wait instead of raising
# 'database is locked' after Python's own 5.0s sqlite3.connect() default.
