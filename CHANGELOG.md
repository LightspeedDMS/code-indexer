...
- SQLite performance indexes for background_jobs, sync_jobs, user_api_keys, user_mcp_credentials, and research_messages tables to eliminate full table scans on dashboard/jobs tab polling and auth lookups
- Idempotent migration creates indexes on existing databases at next server startup
