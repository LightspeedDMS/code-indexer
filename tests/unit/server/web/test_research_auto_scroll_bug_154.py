...
class TestResearchAssistantAutoScroll:
    ...
    def _extract_scroll_script(self, page_content):
        ...
        for script in scripts:
            if (
                script.string
                and "scrollToBottom" in script.string
                and "htmx:afterSwap" in script.string
            ):
    ...
    def test_auto_scroll_enabled_defaults_to_true(
        ...
        assert (
            "autoScrollEnabled = true" in script or "autoScrollEnabled=true" in script
        ...
        for i, line in enumerate(lines):
            if "beforeRequest" in line or "htmx:beforeRequest" in line:
                ...
                if "/admin/research/send" in context or "send" in context.lower():
                    ...
                    assert (
                        "autoScrollEnabled = true" in context
    ...
    def test_chat_messages_element_exists_in_html(
        ...
        assert chat_messages is not None, "Must have element with id='chat-messages'"
