...
def test_api_keys_section_renders_with_github_token():
    ...
    context = {
        ...
        "config": {
            ...
            "reindexing": {"change_percentage_threshold": 10.0, "accuracy_threshold": 0.85, "max_index_age_days": 30, "batch_size": 100, "max_analysis_time_seconds": 300, "max_memory_usage_mb": 512},
            ...
            "git_timeouts": {"git_local_timeout": 30, "git_remote_timeout": 300, "git_command_timeout": 30, "git_fetch_timeout": 60, "github_api_timeout": 30, "gitlab_api_timeout": 30, "github_provider_timeout": 30, "gitlab_provider_timeout": 30},
