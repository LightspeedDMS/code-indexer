    ...
    def _get_base_context(self):
        ...
        return {
            ...
            "config": {
                ...
                "content_limits": {
                    "chars_per_token": 4,
                    "file_content_max_tokens": 50000,
                    "git_diff_max_tokens": 50000,
                    "git_log_max_tokens": 50000,
                    "search_result_max_tokens": 50000,
...
class TestSearchLimitsSectionTemplate(BaseTemplateSectionTest):
    ...
    def test_search_limits_section_exists(self):
        ...
        assert (
            "Search Limits" in rendered
        ), "Search Limits section header should be present"
        assert (
            "section-search_limits" in rendered
        ), "Search Limits section ID should be present"
    ...
    def test_search_limits_edit_form_exists(self):
        ...
        assert (
            'action="/admin/config/search_limits"' in rendered
        ), "Form should POST to /admin/config/search_limits"
        assert (
            'name="max_result_size_mb"' in rendered
        ), "max_result_size_mb input should exist"
        assert (
            'name="timeout_seconds"' in rendered
        ), "timeout_seconds input should exist"
    ...
    def test_search_limits_edit_button(self):
        ...
        assert (
            "toggleEditMode('search_limits')" in rendered
        ), "Edit button should call toggleEditMode('search_limits')"
...
class TestFileContentLimitsSectionTemplate(BaseTemplateSectionTest):
    ...
    def test_file_content_limits_section_exists(self):
        ...
        assert (
            "File Content Limits" in rendered
        ), "File Content Limits section header should be present"
        assert (
            "section-file_content_limits" in rendered
        ), "File Content Limits section ID should be present"
    ...
    def test_file_content_limits_edit_form_exists(self):
        ...
        assert (
            'action="/admin/config/file_content_limits"' in rendered
        ), "Form should POST to /admin/config/file_content_limits"
        assert (
            'name="max_tokens_per_request"' in rendered
        ), "max_tokens_per_request input should exist"
        assert (
            'name="chars_per_token"' in rendered
        ), "chars_per_token input should exist"
    ...
    def test_file_content_limits_edit_button(self):
        ...
        assert (
            "toggleEditMode('file_content_limits')" in rendered
        ), "Edit button should call toggleEditMode('file_content_limits')"
...
class TestGoldenReposSectionTemplate(BaseTemplateSectionTest):
    ...
    def test_golden_repos_section_exists(self):
        ...
        assert (
            "Golden Repos" in rendered
        ), "Golden Repos section header should be present"
        assert (
            "section-golden_repos" in rendered
        ), "Golden Repos section ID should be present"
    ...
    def test_golden_repos_edit_form_exists(self):
        ...
        assert (
            'action="/admin/config/golden_repos"' in rendered
        ), "Form should POST to /admin/config/golden_repos"
        assert (
            'name="refresh_interval_seconds"' in rendered
        ), "refresh_interval_seconds input should exist"
    ...
    def test_golden_repos_edit_button(self):
        ...
        assert (
            "toggleEditMode('golden_repos')" in rendered
        ), "Edit button should call toggleEditMode('golden_repos')"
