        ...
        KNOWN_RUNTIME_KEYS = frozenset(
            {
                ...
                "alias_lock_config",  # Issue #1546 — runtime Web UI setting (operator-controlled DB-backed alias-lock rollout gate; defaults True as of Phase 3, retained as an emergency rollback to file-based locking)
