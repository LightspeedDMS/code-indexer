...
def _make_manager(tmp_path, background_job_manager_factory) -> BackgroundJobManager:
...
class TestProgressDebounceCoalescing:
    ...
    def test_rapid_ticks_do_not_each_call_persist(
        self, tmp_path, background_job_manager_factory
    ):
        """
    ...
    def test_in_memory_state_updated_on_every_tick(
        self, tmp_path, background_job_manager_factory
    ):
        """
...
class TestProgressTerminalFlush:
    ...
    def test_terminal_completed_persists_immediately(
        self, tmp_path, background_job_manager_factory
    ):
        """
    ...
    def test_terminal_failed_persists_immediately(
        self, tmp_path, background_job_manager_factory
    ):
...
class TestProgressCancellationLatency:
    ...
    def test_cancellation_check_called_on_every_tick(
        self, tmp_path, background_job_manager_factory
    ):
        """
