...
the on-disk stamp against the one recorded at load time, but two holes made
...
def _write_index(index_file: Path, item_count: int) -> None:
    ...
    rng = np.random.default_rng(1538)
    index.add_items(
