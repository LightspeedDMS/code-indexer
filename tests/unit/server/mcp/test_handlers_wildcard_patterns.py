...
class TestExpandWildcardPatterns:
    ...
    @patch("code_indexer.server.mcp.handlers._list_global_repos")
    def test_double_star_matches_zero_directories(
        self, mock_get_registry, mock_get_dir
    ):
    ...
    @patch("code_indexer.server.mcp.handlers._get_golden_repos_dir")
    @patch("code_indexer.server.mcp.handlers._list_global_repos")
    def test_star_matches_single_segment(self, mock_get_registry, mock_get_dir):
    ...
    @patch("code_indexer.server.mcp.handlers._get_golden_repos_dir")
    @patch("code_indexer.server.mcp.handlers._list_global_repos")
    def test_question_mark_matches_single_char(self, mock_get_registry, mock_get_dir):
    ...
    @patch("code_indexer.server.mcp.handlers._get_golden_repos_dir")
    @patch("code_indexer.server.mcp.handlers._list_global_repos")
    def test_exact_match_no_wildcard(self, mock_get_registry, mock_get_dir):
    ...
    @patch("code_indexer.server.mcp.handlers._get_golden_repos_dir")
    @patch("code_indexer.server.mcp.handlers._list_global_repos")
    def test_no_matches_returns_empty(self, mock_get_registry, mock_get_dir):
    ...
    @patch("code_indexer.server.mcp.handlers._get_golden_repos_dir")
    @patch("code_indexer.server.mcp.handlers._list_global_repos")
    def test_deduplication_preserves_order(self, mock_get_registry, mock_get_dir):
    ...
    @patch("code_indexer.server.mcp.handlers._get_golden_repos_dir")
    @patch("code_indexer.server.mcp.handlers._list_global_repos")
    def test_mixed_literal_and_wildcard(self, mock_get_registry, mock_get_dir):
    ...
    @patch("code_indexer.server.mcp.handlers._get_golden_repos_dir")
    @patch("code_indexer.server.mcp.handlers._list_global_repos")
    def test_empty_pattern_list(self, mock_get_registry, mock_get_dir):
        """Test empty pattern list returns empty."""
        mock_get_dir.return_value = "/fake/path"
        mock_get_registry.return_value = [{"alias_name": "repo1"}]
    ...
    @patch("code_indexer.server.mcp.handlers._get_golden_repos_dir")
    @patch("code_indexer.server.mcp.handlers._list_global_repos")
    def test_complex_double_star_pattern(self, mock_get_registry, mock_get_dir):
