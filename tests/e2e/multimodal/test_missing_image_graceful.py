...
class TestMissingImageGraceful:
    ...
    def test_missing_image_validation_returns_missing_reason(self, multimodal_repo_path):
        ...
        missing_results = [r for r in all_results if not r.is_valid and r.skip_reason == "missing"]
    ...
    def test_text_content_still_extracted_despite_missing_image(self, multimodal_repo_path):
