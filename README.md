...
**Version 10.0.1** - [Changelog](CHANGELOG.md) | [Migration Guide](docs/migration-to-v10.md) | [Architecture](docs/architecture.md)
...
```bash
pipx install git+https://github.com/LightspeedDMS/code-indexer.git@v10.0.1
...
pip install git+https://github.com/LightspeedDMS/code-indexer.git@v10.0.1
```
