...
**Version 10.31.0** - [Changelog](CHANGELOG.md) | [Migration Guide](docs/migration-to-v10.md) | [Architecture](docs/architecture.md)
...
```bash
pipx install git+https://github.com/LightspeedDMS/code-indexer.git@v10.4.2
...
pip install git+https://github.com/LightspeedDMS/code-indexer.git@v10.4.2
```
