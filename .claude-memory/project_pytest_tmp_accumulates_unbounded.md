...
description: "/tmp/pytest-of-$USER accumulates unbounded across pytest invocations on this dev machine, growing to 70+ GB and driving root disk to 85%+ -- safe to clean dirs older than ~15 min (excluding the live run) when resource-guardian flags disk pressure during a heavy TDD/review session"
metadata:
  type: project
